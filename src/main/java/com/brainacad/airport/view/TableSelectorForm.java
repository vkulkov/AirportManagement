...
import com.brainacad.airport.view.listeners.FrameDisposer;
import com.brainacad.airport.view.listeners.functions.TablePainter;
...
public class TableSelectorForm {
    ...
    public TableSelectorForm(JTable table, JPanel mainPanel) {
        this.table = table;
    ...
    private JComponent createContent() {
        ...
        confirmButton.addActionListener(new TablePainter(table, mainPanel));
        ...
        cancelButton.addActionListener(new FrameDisposer(selectorFrame));
